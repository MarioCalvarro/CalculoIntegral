...
$$A_k = \{x \in \mathbb{R}^n: c\cdot \varphi\left(x\right) < f_k\left(x\right)\}$$
...
$$= \lim_{k\rightarrow\infty} \sum_{S \in P_k} \inf \{f\left(x\right) : x \in S\}\mu\left(S\right) = \lim_k \int_{\left[a, b\right]}\left(\sum m_S \left(f\right) \cdot \chi_S\right) d \mu = \int_{\left[a, b\right]}\lim_k f_k d \mu = \int_{\left[a, b\right]}f d \mu.$$
